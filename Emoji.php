...
class Emoji
{
	...
	public function emoji_docomo_to_unified(	$text){ return $this->emoji_convert($text, 'docomo_to_unified'); }
	public function emoji_kddi_to_unified(		$text){ return $this->emoji_convert($text, 'kddi_to_unified'); }
	public function emoji_softbank_to_unified(	$text){ return $this->emoji_convert($text, 'softbank_to_unified'); }
	public function emoji_google_to_unified(	$text){ return $this->emoji_convert($text, 'google_to_unified'); }
	...
	public function emoji_unified_to_docomo(	$text){ return $this->emoji_convert($text, 'unified_to_docomo'); }
	public function emoji_unified_to_kddi(		$text){ return $this->emoji_convert($text, 'unified_to_kddi'); }
	public function emoji_unified_to_softbank(	$text){ return $this->emoji_convert($text, 'unified_to_softbank'); }
	public function emoji_unified_to_google(	$text){ return $this->emoji_convert($text, 'unified_to_google'); }
	...
	public function emoji_contains_emoji($text){
